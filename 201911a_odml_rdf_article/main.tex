...
To make use of the RDF feature of validating individual RDF files, we created an odML RDF ontology which includes the basic set of odML RDFS terms and included all currently supported odml:Section subclasses. The complete file can be found in the Appendix under Listing ~\ref{lst:ontology}. This list of subclasses should not be seen as permanent and is expected to increase in the future.
