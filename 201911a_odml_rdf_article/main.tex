...
%[TW] odML terminologies should be introduced %[MS] added a paragraph in front of the file format description to not break the reading flow at this point. Can be changed if it works better at another spot.
